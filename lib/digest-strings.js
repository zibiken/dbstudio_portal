...
const T = {
  ...
  'question.created': {
    en: ({ questionPreview }) => `A question for you${questionPreview ? `: ${questionPreview}` : ''}`,
    nl: ({ questionPreview }) => `Er is een vraag voor je${questionPreview ? `: ${questionPreview}` : ''}`,
    es: ({ questionPreview }) => `Una pregunta para ti${questionPreview ? `: ${questionPreview}` : ''}`,
  },
  'question.answered': {
    en: ({ customerName }) => `${customerName ?? 'A customer'} answered a question`,
    nl: ({ customerName }) => `${customerName ?? 'Een klant'} heeft een vraag beantwoord`,
    es: ({ customerName }) => `${customerName ?? 'Un cliente'} respondió una pregunta`,
  },
  'question.skipped': {
    en: ({ customerName }) => `${customerName ?? 'A customer'} skipped a question`,
    nl: ({ customerName }) => `${customerName ?? 'Een klant'} heeft een vraag overgeslagen`,
    es: ({ customerName }) => `${customerName ?? 'Un cliente'} omitió una pregunta`,
  },
};
