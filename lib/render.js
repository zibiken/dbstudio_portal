...
// /static/* assets. Every restart bumps this so browsers re-fetch JS
// and CSS instead of serving the pre-deploy version through Cloudflare's
// 4-hour edge cache.
...
const VIEW_GLOBALS = Object.freeze({
  euDate, euDateTime,
